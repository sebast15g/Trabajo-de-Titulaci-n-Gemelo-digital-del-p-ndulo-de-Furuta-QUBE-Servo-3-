% FIGURAS_COMPARACION_KE52  Variante con QSM/SIM analitico a ke=52 (swing-up 7 vaivenes).
% Set desglosado de figuras comparativas de las 4 modalidades (variante ke=52).
...
fp.QSM1='fid_E1_qsm.mat'; fp.QSM2='fid_E2_qsm.mat'; fp.QSM3='fid_E3_qsm_ke52.mat';
fp.QHW1='fid_E1_qhw.mat'; fp.QHW2='fid_E2_qhw.mat'; fp.QHW3='fid_E3_qhw.mat';
fp.SIM1='fid_E1_sim.mat'; fp.SIM2='fid_E2_sim.mat'; fp.SIM3='fid_E3_sim_ke52.mat';
...
for i=1:size(sig,1)
  ...
  sv(f,fullfile(out,sprintf('comp_E3_%s_4mod_ke52.png',sig{i,4})));
end
...
sv(f,fullfile(out,'comp_E1_alpha_4mod_ke52.png'));
...
sv(f,fullfile(out,'comp_E2_alpha_theta_4mod_ke52.png'));

% ---------- (2) SUBPLOTS: cada modalidad a solas vs el real ----------
subs_vs_real('E1','al',fp,C,LB,out,'comp_E1_alpha_vsreal_ke52.png','\alpha [deg]',1);
subs_vs_real('E2','al',fp,C,LB,out,'comp_E2_alpha_vsreal_ke52.png','\alpha [deg]',0);
subs_vs_real('E2','th',fp,C,LB,out,'comp_E2_theta_vsreal_ke52.png','\theta [deg]',0);
subs_vs_real_e3(E3,C,LB,out,'comp_E3_alpha_vsreal_ke52.png','alc','\alpha [deg] (arriba=0)');
subs_vs_real_e3(E3,C,LB,out,'comp_E3_theta_vsreal_ke52.png','th','\theta [deg]');
